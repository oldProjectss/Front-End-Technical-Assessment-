...
const createArea = () => {
  ...
  let newArea = document.createElement('input');
  ...
  // Add an event listener to the input for lintning to '/h1/ command to make sure the text is converted to an h1 style
